...
void init()
{
  ...
  _pc[1][0] = 2;
  _pc[2][0] = 2;
  __VERIFIER_assume((_Lvalue[0][0] == (-1)) || (_Lvalue[0][0] == 1));
  __VERIFIER_assume((_Lvalue[1][0] == (-1)) || (_Lvalue[1][0] == 1));
  __VERIFIER_assume((_Lvalue[2][0] == (-1)) || (_Lvalue[2][0] == 1));
  __VERIFIER_assume((_Lvalue[0][1] == (-1)) || (_Lvalue[0][1] == 1));
  __VERIFIER_assume((_Lvalue[1][1] == (-1)) || (_Lvalue[1][1] == 1));
  __VERIFIER_assume((_Lvalue[2][1] == (-1)) || (_Lvalue[2][1] == 1));
  __VERIFIER_assume((_I[0][0] >= 0) && (_I[0][0] < (5 - 0)));
  __VERIFIER_assume((_I[1][0] >= 0) && (_I[1][0] < (5 - 0)));
  __VERIFIER_assume((_I[2][0] >= 0) && (_I[2][0] < (5 - 0)));
  __VERIFIER_assume((_I[0][1] >= 0) && (_I[0][1] < (5 - 0)));
  __VERIFIER_assume((_I[1][1] >= 0) && (_I[1][1] < (5 - 0)));
  __VERIFIER_assume((_I[2][1] >= 0) && (_I[2][1] < (5 - 0)));
...
void _0_2(int tid)
{
  TYPEOFVALUES val0 = mod(I[tid][0] + Lvalue[tid][0], 5);
  TYPEOFVALUES val1 = mod(I[tid][1] + Lvalue[tid][1], 5);
  attr(tid, 0, val0, 1);
  attr(tid, 1, val1, 0);
  setHin(tid, 0);
  setHin(tid, 1);
