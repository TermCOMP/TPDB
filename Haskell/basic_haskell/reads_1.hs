{-# htermination (readsTup0 :: (List Char)  ->  (List (Tup2 Tup0 (List Char)))) #-} 
...
lex12LexExp00 e c vux = Nil;

lex12LexExp0 e c vu65 = lex12LexExp00 e c vu65;

nonnull00 (Tup2 (Cons yz zu) t) = Cons (Tup2 (Cons yz zu) t) Nil;
nonnull00 zv = Nil;
...
span2Span0 zuw zux p vvy vvz MyTrue = Tup2 Nil (Cons vvy vvz);

span2Vu43 zuw zux = span zuw zux;

span2Ys0 zuw zux (Tup2 ys vwu) = ys;

span2Ys zuw zux = span2Ys0 zuw zux (span2Vu43 zuw zux);

span2Zs0 zuw zux (Tup2 vwv zs) = zs;

span2Zs zuw zux = span2Zs0 zuw zux (span2Vu43 zuw zux);

span2Span1 zuw zux p vvy vvz MyTrue = Tup2 (Cons vvy (span2Ys zuw zux)) (span2Zs zuw zux);
span2Span1 zuw zux p vvy vvz MyFalse = span2Span0 zuw zux p vvy vvz otherwise;

span2 p (Cons vvy vvz) = span2Span1 p vvz p vvy vvz (p vvy);

span3 p Nil = Tup2 Nil Nil;
span3 yzu yzv = span2 yzu yzv;

span :: (a  ->  MyBool)  ->  (List a)  ->  Tup2 (List a) (List a);
span p Nil = span3 p Nil;
span p (Cons vvy vvz) = span2 p (Cons vvy vvz);
...
lex12LexExp5 yvw = lex12LexExp3 yvw;
...
lex12LexFracExp10 vuz = Nil;

lex12LexFracExp1 vu64 = lex12LexFracExp10 vu64;

lex12LexFracExp3 yuu c cs MyTrue = concatMap lex12LexFracExp1 (lexDigits (Cons c cs));
lex12LexFracExp3 yuu c cs MyFalse = lex12LexFracExp2 (Cons yuu (Cons c cs));

lex12LexFracExp4 MyTrue (Cons yuu (Cons c cs)) = lex12LexFracExp3 yuu c cs (isDigit c);
lex12LexFracExp4 yuy yuz = lex12LexFracExp2 yuz;

lex12LexFracExp5 (Cons yuu yux) = lex12LexFracExp4 (esEsChar yuu (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))) (Cons yuu yux);
lex12LexFracExp5 yvu = lex12LexFracExp2 yvu;

lex12LexFracExp (Cons yuu yux) = lex12LexFracExp5 (Cons yuu yux);
lex12LexFracExp s = lex12LexFracExp2 s;

lex12Lex50 c (Tup2 ds s) = concatMap (lex12Lex4 c ds) (lex12LexFracExp s);
lex12Lex50 c vvx = Nil;
...
lexLitChar2LexEsc3 xw = Nil;

lexLitChar2LexEsc00 mne (Tup2 Nil s') = Cons (Tup2 mne s') Nil;
lexLitChar2LexEsc00 mne xy = Nil;
...
lexmatch2 vwz vxu = lexmatch0 vwz vxu;
...
lexLitChar2LexEsc10 s wy = Nil;

lexLitChar2LexEsc1 s vu70 = lexLitChar2LexEsc10 s vu70;

lexLitChar2LexEsc2 (Cons pr xx) = Cons pr Nil;
...
takeWhile3 yyw yyx = takeWhile2 yyw yyx;
...
lexLitChar2LexEsc4 xu xv MyTrue = lexLitChar2LexEsc2 (concatMap (lexLitChar2LexEsc1 (Cons xu xv)) lexLitChar2Table);
lexLitChar2LexEsc4 xu xv MyFalse = lexLitChar2LexEsc3 (Cons xu xv);

lexLitChar2LexEsc5 xu xv MyTrue = Cons (span isDigit (Cons xu xv)) Nil;
lexLitChar2LexEsc5 xu xv MyFalse = lexLitChar2LexEsc4 xu xv (isUpper xu);

lexLitChar2LexEsc6 (Cons xu xv) = lexLitChar2LexEsc5 xu xv (isDigit xu);
lexLitChar2LexEsc6 wuy = lexLitChar2LexEsc3 wuy;
...
lexLitChar2LexEsc7 MyTrue (Cons wvu s) = Cons (lexLitChar2Prefix (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (span isHexDigit s)) Nil;
lexLitChar2LexEsc7 wvv wvw = lexLitChar2LexEsc6 wvw;

lexLitChar2LexEsc8 (Cons wvu s) = lexLitChar2LexEsc7 (esEsChar wvu (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons wvu s);
lexLitChar2LexEsc8 wvx = lexLitChar2LexEsc6 wvx;
...
lexLitChar2LexEsc9 MyTrue (Cons wvz s) = Cons (lexLitChar2Prefix (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (span isOctDigit s)) Nil;
lexLitChar2LexEsc9 wwu wwv = lexLitChar2LexEsc8 wwv;

lexLitChar2LexEsc11 (Cons wvz s) = lexLitChar2LexEsc9 (esEsChar wvz (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons wvz s);
lexLitChar2LexEsc11 www = lexLitChar2LexEsc8 www;

lexLitChar2LexEsc12 wwy c s MyTrue = Cons (Tup2 (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons c Nil)) s) Nil;
lexLitChar2LexEsc12 wwy c s MyFalse = lexLitChar2LexEsc11 (Cons wwy (Cons c s));

lexLitChar2LexEsc13 MyTrue (Cons wwy (Cons c s)) = lexLitChar2LexEsc12 wwy c s (asAs (gtEsChar c (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (ltEsChar c (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
lexLitChar2LexEsc13 wxw wxx = lexLitChar2LexEsc11 wxx;

lexLitChar2LexEsc14 (Cons wwy wxv) = lexLitChar2LexEsc13 (esEsChar wwy (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons wwy wxv);
lexLitChar2LexEsc14 wxy = lexLitChar2LexEsc11 wxy;
...
lexLitChar2LexEsc16 wyu = lexLitChar2LexEsc14 wyu;

lexLitChar2LexEsc (Cons c s) = lexLitChar2LexEsc16 (Cons c s);
lexLitChar2LexEsc (Cons wwy wxv) = lexLitChar2LexEsc14 (Cons wwy wxv);
lexLitChar2LexEsc (Cons wvz s) = lexLitChar2LexEsc11 (Cons wvz s);
lexLitChar2LexEsc (Cons wvu s) = lexLitChar2LexEsc8 (Cons wvu s);
lexLitChar2LexEsc (Cons xu xv) = lexLitChar2LexEsc6 (Cons xu xv);
lexLitChar2LexEsc xw = lexLitChar2LexEsc3 xw;
...
lexLitChar3 Nil = Nil;
lexLitChar3 wyx = lexLitChar2 wyx;
...
dropWhile3 vxx vxy = dropWhile2 vxx vxy;

dropWhile :: (a  ->  MyBool)  ->  (List a)  ->  (List a);
dropWhile p Nil = dropWhile3 p Nil;
dropWhile p (Cons vz wu) = dropWhile2 p (Cons vz wu);

lex13LexStrItem000 vuu = Nil;

lex13LexStrItem001 MyTrue (Cons xzv t) = Cons (Tup2 Nil t) Nil;
lex13LexStrItem001 xzw xzx = lex13LexStrItem000 xzx;

lex13LexStrItem002 (Cons xzv t) = lex13LexStrItem001 (esEsChar xzv (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons xzv t);
lex13LexStrItem002 xzy = lex13LexStrItem000 xzy;

lex13LexStrItem00 (Cons xzv t) = lex13LexStrItem002 (Cons xzv t);
lex13LexStrItem00 vuu = lex13LexStrItem000 vuu;

lex13LexStrItem0 vu58 = lex13LexStrItem00 vu58;

lex13LexStrItem2 xwu c s MyTrue = concatMap lex13LexStrItem0 (Cons (dropWhile isSpace s) Nil);
lex13LexStrItem2 xwu c s MyFalse = lex13LexStrItem1 (Cons xwu (Cons c s));

lex13LexStrItem3 MyTrue (Cons xwu (Cons c s)) = lex13LexStrItem2 xwu c s (isSpace c);
lex13LexStrItem3 xwy xwz = lex13LexStrItem1 xwz;

lex13LexStrItem4 (Cons xwu xwx) = lex13LexStrItem3 (esEsChar xwu (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons xwu xwx);
lex13LexStrItem4 xxu = lex13LexStrItem1 xxu;

lex13LexStrItem5 MyTrue (Cons xxw (Cons xxy s)) = Cons (Tup2 (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))) Nil)) s) Nil;
lex13LexStrItem5 xyv xyw = lex13LexStrItem4 xyw;

lex13LexStrItem6 MyTrue (Cons xxw (Cons xxy s)) = lex13LexStrItem5 (esEsChar xxy (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))) (Cons xxw (Cons xxy s));
lex13LexStrItem6 xyx xyy = lex13LexStrItem4 xyy;

lex13LexStrItem7 (Cons xxw xyu) = lex13LexStrItem6 (esEsChar xxw (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons xxw xyu);
lex13LexStrItem7 xyz = lex13LexStrItem4 xyz;

lex13LexStrItem (Cons xxw xyu) = lex13LexStrItem7 (Cons xxw xyu);
lex13LexStrItem (Cons xwu xwx) = lex13LexStrItem4 (Cons xwu xwx);
lex13LexStrItem s = lex13LexStrItem1 s;

lex13LexString00 ch (Tup2 str u) = Cons (Tup2 (psPs ch str) u) Nil;
lex13LexString00 ch zz = Nil;

lex13LexString0 ch vu56 = lex13LexString00 ch vu56;

lex13LexString10 (Tup2 ch t) = concatMap (lex13LexString0 ch) (lex13LexString t);
lex13LexString10 zy = Nil;

lex13LexString1 vu57 = lex13LexString10 vu57;

lex13LexString2 s = concatMap lex13LexString1 (lex13LexStrItem s);

lex13LexString3 MyTrue (Cons xvv s) = Cons (Tup2 (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))) Nil) s) Nil;
lex13LexString3 xvw xvx = lex13LexString2 xvx;

lex13LexString4 (Cons xvv s) = lex13LexString3 (esEsChar xvv (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))) (Cons xvv s);
lex13LexString4 xvy = lex13LexString2 xvy;

lex13LexString (Cons xvv s) = lex13LexString4 (Cons xvv s);
lex13LexString s = lex13LexString2 s;

lex13 MyTrue (Cons yvz s) = concatMap lex13Lex1 (lex13LexString s);
lex13 ywu ywv = lex12 ywv;

lex14 (Cons yvz s) = lex13 (esEsChar yvz (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))) (Cons yvz s);
lex14 yww = lex12 yww;

lex001 vww = Nil;

fsEsListChar0 MyTrue xs ys = fsEsListChar xs ys
fsEsListChar0 MyFalse xs ys = MyFalse

fsEsListChar :: (List Char) -> (List Char) -> MyBool
fsEsListChar Nil Nil = MyTrue
fsEsListChar Nil ys = MyFalse
fsEsListChar xs Nil = MyFalse
...
lex002 MyTrue (Tup2 ch (Cons yzy t)) = lex000 ch t (fsEsListChar ch (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))) Nil));
lex002 yzz zuu = lex001 zuu;

lex003 (Tup2 ch (Cons yzy t)) = lex002 (esEsChar yzy (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))) (Tup2 ch (Cons yzy t));
lex003 zuv = lex001 zuv;

lex00 (Tup2 ch (Cons yzy t)) = lex003 (Tup2 ch (Cons yzy t));
lex00 vww = lex001 vww;

lex0 vu54 = lex00 vu54;

lex15 MyTrue (Cons ywy s) = concatMap lex0 (lexLitChar s);
lex15 ywz yxu = lex14 yxu;

lex16 (Cons ywy s) = lex15 (esEsChar ywy (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))) (Cons ywy s);
lex16 yxv = lex14 yxv;
...
lex (Cons ywy s) = lex16 (Cons ywy s);
lex (Cons yvz s) = lex14 (Cons yvz s);
lex (Cons c s) = lex12 (Cons c s);

readParenMandatory200 zuy ww = Nil;

readParenMandatory000 zuy x wx = Nil;

readParenMandatory001 zuy MyTrue x (Tup2 (Cons vzw Nil) u) = Cons (Tup2 x u) Nil;
readParenMandatory001 zuy vzy vzz wuu = readParenMandatory000 zuy vzz wuu;

readParenMandatory002 zuy x (Tup2 (Cons vzw vzx) u) = readParenMandatory001 zuy (esEsChar vzw (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))) x (Tup2 (Cons vzw vzx) u);
readParenMandatory002 zuy wuv wuw = readParenMandatory000 zuy wuv wuw;

readParenMandatory00 zuy x (Tup2 (Cons vzw vzx) u) = readParenMandatory002 zuy x (Tup2 (Cons vzw vzx) u);
readParenMandatory00 zuy x wx = readParenMandatory000 zuy x wx;

readParenMandatory0 zuy x vu48 = readParenMandatory00 zuy x vu48;

readParenMandatory10 zuy (Tup2 x t) = concatMap (readParenMandatory0 zuy x) (lex t);
readParenMandatory10 zuy wv = Nil;

readParenMandatory1 zuy vu49 = readParenMandatory10 zuy vu49;

readParenOptional zuy r = psPs (zuy r) (readParenMandatory zuy r);

readParenMandatory201 zuy MyTrue (Tup2 (Cons vyv Nil) s) = concatMap (readParenMandatory1 zuy) (readParenOptional zuy s);
readParenMandatory201 zuy vyx vyy = readParenMandatory200 zuy vyy;

readParenMandatory202 zuy (Tup2 (Cons vyv vyw) s) = readParenMandatory201 zuy (esEsChar vyv (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))) (Tup2 (Cons vyv vyw) s);
readParenMandatory202 zuy vyz = readParenMandatory200 zuy vyz;

readParenMandatory20 zuy (Tup2 (Cons vyv vyw) s) = readParenMandatory202 zuy (Tup2 (Cons vyv vyw) s);
readParenMandatory20 zuy ww = readParenMandatory200 zuy ww;

readParenMandatory2 zuy vu50 = readParenMandatory20 zuy vu50;

readParenMandatory zuy r = concatMap (readParenMandatory2 zuy) (lex r);

readParenReadParen0 zuy MyTrue = readParenMandatory zuy;
readParenReadParen0 zuy MyFalse = readParenOptional zuy;
...
readsPrec001 MyTrue (Tup2 (Cons xuv Nil) t) = Cons (Tup2 Tup0 t) Nil;
readsPrec001 xux xuy = readsPrec000 xuy;

readsPrec002 (Tup2 (Cons xuv xuw) t) = readsPrec001 (esEsChar xuv (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))) (Tup2 (Cons xuv xuw) t);
readsPrec002 xuz = readsPrec000 xuz;

readsPrec00 (Tup2 (Cons xuv xuw) t) = readsPrec002 (Tup2 (Cons xuv xuw) t);
readsPrec00 zw = readsPrec000 zw;

readsPrec0 vu22 = readsPrec00 vu22;

readsPrec101 MyTrue (Tup2 (Cons wzu Nil) s) = concatMap readsPrec0 (lex s);
readsPrec101 wzw wzx = readsPrec100 wzx;

readsPrec102 (Tup2 (Cons wzu wzv) s) = readsPrec101 (esEsChar wzu (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))) (Tup2 (Cons wzu wzv) s);
readsPrec102 wzy = readsPrec100 wzy;

readsPrec10 (Tup2 (Cons wzu wzv) s) = readsPrec102 (Tup2 (Cons wzu wzv) s);
readsPrec10 xz = readsPrec100 xz;

readsPrec1 vu23 = readsPrec10 vu23;

readsPrec2 r = concatMap readsPrec1 (lex r);

readsPrecTup0 :: MyInt  ->  (List Char)  ->  (List (Tup2 Tup0 (List Char)))
readsPrecTup0 p = readParen MyFalse readsPrec2;

readsTup0 :: (List Char)  ->  (List (Tup2 Tup0 (List Char)))
readsTup0 = readsPrecTup0 (Pos Zero);
