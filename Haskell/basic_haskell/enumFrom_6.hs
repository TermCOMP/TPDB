{-# htermination (enumFromOrdering :: Ordering  ->  (List Ordering)) #-} 
...
enumFromToOrdering :: Ordering  ->  Ordering  ->  (List Ordering)
enumFromToOrdering x y = map toEnumOrdering (enumFromToMyInt (fromEnumOrdering x) (fromEnumOrdering y));

enumFromOrdering :: Ordering  ->  (List Ordering)
