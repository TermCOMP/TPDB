{-# htermination (readsPrecMyInt :: MyInt  ->  (List Char)  ->  (List (Tup2 MyInt (List Char)))) #-} 
...
nonnull00 (Tup2 (Cons zx zy) t) = Cons (Tup2 (Cons zx zy) t) Nil;
nonnull00 zz = Nil;
...
span2Span0 yzy yzz p vwv vww MyTrue = Tup2 Nil (Cons vwv vww);

span2Vu43 yzy yzz = span yzy yzz;

span2Ys0 yzy yzz (Tup2 ys vwx) = ys;

span2Ys yzy yzz = span2Ys0 yzy yzz (span2Vu43 yzy yzz);

span2Zs0 yzy yzz (Tup2 vwy zs) = zs;

span2Zs yzy yzz = span2Zs0 yzy yzz (span2Vu43 yzy yzz);

span2Span1 yzy yzz p vwv vww MyTrue = Tup2 (Cons vwv (span2Ys yzy yzz)) (span2Zs yzy yzz);
span2Span1 yzy yzz p vwv vww MyFalse = span2Span0 yzy yzz p vwv vww otherwise;

span2 p (Cons vwv vww) = span2Span1 p vww p vwv vww (p vwv);

span3 p Nil = Tup2 Nil Nil;
span3 yyw yyx = span2 yyw yyx;
...
readInt10 radix digToInt xw = Nil;
...
lex12LexExp5 yuy = lex12LexExp3 yuy;
...
lex12LexFracExp10 vvw = Nil;

lex12LexFracExp1 vu64 = lex12LexFracExp10 vu64;

lex12LexFracExp3 xzw c cs MyTrue = concatMap lex12LexFracExp1 (lexDigits (Cons c cs));
lex12LexFracExp3 xzw c cs MyFalse = lex12LexFracExp2 (Cons xzw (Cons c cs));

lex12LexFracExp4 MyTrue (Cons xzw (Cons c cs)) = lex12LexFracExp3 xzw c cs (isDigit c);
lex12LexFracExp4 yuu yuv = lex12LexFracExp2 yuv;

lex12LexFracExp5 (Cons xzw xzz) = lex12LexFracExp4 (esEsChar xzw (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))) (Cons xzw xzz);
lex12LexFracExp5 yuw = lex12LexFracExp2 yuw;

lex12LexFracExp (Cons xzw xzz) = lex12LexFracExp5 (Cons xzw xzz);
lex12LexFracExp s = lex12LexFracExp2 s;

lex12Lex50 c (Tup2 ds s) = concatMap (lex12Lex4 c ds) (lex12LexFracExp s);
lex12Lex50 c vwu = Nil;
...
lexLitChar2LexEsc3 yv = Nil;

lexLitChar2LexEsc00 mne (Tup2 Nil s') = Cons (Tup2 mne s') Nil;
lexLitChar2LexEsc00 mne yx = Nil;
...
lexmatch2 vyx vyy = lexmatch0 vyx vyy;
...
lexLitChar2LexEsc10 s xx = Nil;

lexLitChar2LexEsc1 s vu70 = lexLitChar2LexEsc10 s vu70;

lexLitChar2LexEsc2 (Cons pr yw) = Cons pr Nil;
...
takeWhile3 yxy yxz = takeWhile2 yxy yxz;
...
lexLitChar2LexEsc4 xz yu MyTrue = lexLitChar2LexEsc2 (concatMap (lexLitChar2LexEsc1 (Cons xz yu)) lexLitChar2Table);
lexLitChar2LexEsc4 xz yu MyFalse = lexLitChar2LexEsc3 (Cons xz yu);

lexLitChar2LexEsc5 xz yu MyTrue = Cons (span isDigit (Cons xz yu)) Nil;
lexLitChar2LexEsc5 xz yu MyFalse = lexLitChar2LexEsc4 xz yu (isUpper xz);

lexLitChar2LexEsc6 (Cons xz yu) = lexLitChar2LexEsc5 xz yu (isDigit xz);
lexLitChar2LexEsc6 www = lexLitChar2LexEsc3 www;
...
lexLitChar2LexEsc7 MyTrue (Cons wwy s) = Cons (lexLitChar2Prefix (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (span isHexDigit s)) Nil;
lexLitChar2LexEsc7 wwz wxu = lexLitChar2LexEsc6 wxu;

lexLitChar2LexEsc8 (Cons wwy s) = lexLitChar2LexEsc7 (esEsChar wwy (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons wwy s);
lexLitChar2LexEsc8 wxv = lexLitChar2LexEsc6 wxv;
...
lexLitChar2LexEsc9 MyTrue (Cons wxx s) = Cons (lexLitChar2Prefix (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (span isOctDigit s)) Nil;
lexLitChar2LexEsc9 wxy wxz = lexLitChar2LexEsc8 wxz;

lexLitChar2LexEsc11 (Cons wxx s) = lexLitChar2LexEsc9 (esEsChar wxx (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons wxx s);
lexLitChar2LexEsc11 wyu = lexLitChar2LexEsc8 wyu;

lexLitChar2LexEsc12 wyw c s MyTrue = Cons (Tup2 (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons c Nil)) s) Nil;
lexLitChar2LexEsc12 wyw c s MyFalse = lexLitChar2LexEsc11 (Cons wyw (Cons c s));

lexLitChar2LexEsc13 MyTrue (Cons wyw (Cons c s)) = lexLitChar2LexEsc12 wyw c s (asAs (gtEsChar c (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (ltEsChar c (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
lexLitChar2LexEsc13 wzu wzv = lexLitChar2LexEsc11 wzv;

lexLitChar2LexEsc14 (Cons wyw wyz) = lexLitChar2LexEsc13 (esEsChar wyw (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons wyw wyz);
lexLitChar2LexEsc14 wzw = lexLitChar2LexEsc11 wzw;
...
lexLitChar2LexEsc16 wzy = lexLitChar2LexEsc14 wzy;

lexLitChar2LexEsc (Cons c s) = lexLitChar2LexEsc16 (Cons c s);
lexLitChar2LexEsc (Cons wyw wyz) = lexLitChar2LexEsc14 (Cons wyw wyz);
lexLitChar2LexEsc (Cons wxx s) = lexLitChar2LexEsc11 (Cons wxx s);
lexLitChar2LexEsc (Cons wwy s) = lexLitChar2LexEsc8 (Cons wwy s);
lexLitChar2LexEsc (Cons xz yu) = lexLitChar2LexEsc6 (Cons xz yu);
lexLitChar2LexEsc yv = lexLitChar2LexEsc3 yv;
...
lexLitChar3 Nil = Nil;
lexLitChar3 xuv = lexLitChar2 xuv;
...
dropWhile3 vzv vzw = dropWhile2 vzv vzw;

dropWhile :: (a  ->  MyBool)  ->  (List a)  ->  (List a);
dropWhile p Nil = dropWhile3 p Nil;
dropWhile p (Cons wx wy) = dropWhile2 p (Cons wx wy);

lex13LexStrItem000 vux = Nil;

lex13LexStrItem001 MyTrue (Cons xyx t) = Cons (Tup2 Nil t) Nil;
lex13LexStrItem001 xyy xyz = lex13LexStrItem000 xyz;

lex13LexStrItem002 (Cons xyx t) = lex13LexStrItem001 (esEsChar xyx (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons xyx t);
lex13LexStrItem002 xzu = lex13LexStrItem000 xzu;

lex13LexStrItem00 (Cons xyx t) = lex13LexStrItem002 (Cons xyx t);
lex13LexStrItem00 vux = lex13LexStrItem000 vux;

lex13LexStrItem0 vu58 = lex13LexStrItem00 vu58;

lex13LexStrItem2 xvw c s MyTrue = concatMap lex13LexStrItem0 (Cons (dropWhile isSpace s) Nil);
lex13LexStrItem2 xvw c s MyFalse = lex13LexStrItem1 (Cons xvw (Cons c s));

lex13LexStrItem3 MyTrue (Cons xvw (Cons c s)) = lex13LexStrItem2 xvw c s (isSpace c);
lex13LexStrItem3 xwu xwv = lex13LexStrItem1 xwv;

lex13LexStrItem4 (Cons xvw xvz) = lex13LexStrItem3 (esEsChar xvw (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons xvw xvz);
lex13LexStrItem4 xww = lex13LexStrItem1 xww;

lex13LexStrItem5 MyTrue (Cons xwy (Cons xxu s)) = Cons (Tup2 (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))) Nil)) s) Nil;
lex13LexStrItem5 xxx xxy = lex13LexStrItem4 xxy;

lex13LexStrItem6 MyTrue (Cons xwy (Cons xxu s)) = lex13LexStrItem5 (esEsChar xxu (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))) (Cons xwy (Cons xxu s));
lex13LexStrItem6 xxz xyu = lex13LexStrItem4 xyu;

lex13LexStrItem7 (Cons xwy xxw) = lex13LexStrItem6 (esEsChar xwy (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons xwy xxw);
lex13LexStrItem7 xyv = lex13LexStrItem4 xyv;

lex13LexStrItem (Cons xwy xxw) = lex13LexStrItem7 (Cons xwy xxw);
lex13LexStrItem (Cons xvw xvz) = lex13LexStrItem4 (Cons xvw xvz);
lex13LexStrItem s = lex13LexStrItem1 s;

lex13LexString00 ch (Tup2 str u) = Cons (Tup2 (psPs ch str) u) Nil;
lex13LexString00 ch vuw = Nil;

lex13LexString0 ch vu56 = lex13LexString00 ch vu56;

lex13LexString10 (Tup2 ch t) = concatMap (lex13LexString0 ch) (lex13LexString t);
lex13LexString10 vuv = Nil;

lex13LexString1 vu57 = lex13LexString10 vu57;

lex13LexString2 s = concatMap lex13LexString1 (lex13LexStrItem s);

lex13LexString3 MyTrue (Cons xux s) = Cons (Tup2 (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))) Nil) s) Nil;
lex13LexString3 xuy xuz = lex13LexString2 xuz;

lex13LexString4 (Cons xux s) = lex13LexString3 (esEsChar xux (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))) (Cons xux s);
lex13LexString4 xvu = lex13LexString2 xvu;

lex13LexString (Cons xux s) = lex13LexString4 (Cons xux s);
lex13LexString s = lex13LexString2 s;

lex13 MyTrue (Cons yvv s) = concatMap lex13Lex1 (lex13LexString s);
lex13 yvw yvx = lex12 yvx;

lex14 (Cons yvv s) = lex13 (esEsChar yvv (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))) (Cons yvv s);
lex14 yvy = lex12 yvy;
...
lex002 MyTrue (Tup2 ch (Cons yzu t)) = lex000 ch t (fsEsListChar ch (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))) Nil));
lex002 yzv yzw = lex001 yzw;

lex003 (Tup2 ch (Cons yzu t)) = lex002 (esEsChar yzu (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))) (Tup2 ch (Cons yzu t));
lex003 yzx = lex001 yzx;

lex00 (Tup2 ch (Cons yzu t)) = lex003 (Tup2 ch (Cons yzu t));
lex00 vwz = lex001 vwz;

lex0 vu54 = lex00 vu54;

lex15 MyTrue (Cons ywu s) = concatMap lex0 (lexLitChar s);
lex15 ywv yww = lex14 yww;

lex16 (Cons ywu s) = lex15 (esEsChar ywu (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))) (Cons ywu s);
lex16 ywx = lex14 ywx;
...
lex (Cons ywu s) = lex16 (Cons ywu s);
lex (Cons yvv s) = lex14 (Cons yvv s);
lex (Cons c s) = lex12 (Cons c s);

readParenMandatory200 zuv xu = Nil;

readParenMandatory000 zuv x xv = Nil;

readParenMandatory001 zuv MyTrue x (Tup2 (Cons wvu Nil) u) = Cons (Tup2 x u) Nil;
readParenMandatory001 zuv wvw wvx wvy = readParenMandatory000 zuv wvx wvy;

readParenMandatory002 zuv x (Tup2 (Cons wvu wvv) u) = readParenMandatory001 zuv (esEsChar wvu (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))) x (Tup2 (Cons wvu wvv) u);
readParenMandatory002 zuv wvz wwu = readParenMandatory000 zuv wvz wwu;

readParenMandatory00 zuv x (Tup2 (Cons wvu wvv) u) = readParenMandatory002 zuv x (Tup2 (Cons wvu wvv) u);
readParenMandatory00 zuv x xv = readParenMandatory000 zuv x xv;

readParenMandatory0 zuv x vu48 = readParenMandatory00 zuv x vu48;

readParenMandatory10 zuv (Tup2 x t) = concatMap (readParenMandatory0 zuv x) (lex t);
readParenMandatory10 zuv wz = Nil;

readParenMandatory1 zuv vu49 = readParenMandatory10 zuv vu49;

readParenOptional zuv r = psPs (zuv r) (readParenMandatory zuv r);

readParenMandatory201 zuv MyTrue (Tup2 (Cons vzz Nil) s) = concatMap (readParenMandatory1 zuv) (readParenOptional zuv s);
readParenMandatory201 zuv wuv wuw = readParenMandatory200 zuv wuw;

readParenMandatory202 zuv (Tup2 (Cons vzz wuu) s) = readParenMandatory201 zuv (esEsChar vzz (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))) (Tup2 (Cons vzz wuu) s);
readParenMandatory202 zuv wux = readParenMandatory200 zuv wux;

readParenMandatory20 zuv (Tup2 (Cons vzz wuu) s) = readParenMandatory202 zuv (Tup2 (Cons vzz wuu) s);
readParenMandatory20 zuv xu = readParenMandatory200 zuv xu;

readParenMandatory2 zuv vu50 = readParenMandatory20 zuv vu50;

readParenMandatory zuv r = concatMap (readParenMandatory2 zuv) (lex r);

readParenReadParen0 zuv MyTrue = readParenMandatory zuv;
readParenReadParen0 zuv MyFalse = readParenOptional zuv;

readParen :: MyBool  ->  ((List Char)  ->  (List (Tup2 a (List Char))))  ->  (List Char)  ->  (List (Tup2 a (List Char)));
readParen b g = readParenReadParen0 g b;

readSignedRead''00 zuu s (Tup2 n Nil) = Cons (Tup2 n s) Nil;
readSignedRead''00 zuu s wu = Nil;

readSignedRead''0 zuu s vu80 = readSignedRead''00 zuu s vu80;

readSignedRead''10 zuu readPos (Tup2 str s) = concatMap (readSignedRead''0 zuu s) (readPos str);
readSignedRead''10 zuu readPos vy = Nil;

readSignedRead''1 zuu readPos vu81 = readSignedRead''10 zuu readPos vu81;

readSignedRead'' zuu r = concatMap (readSignedRead''1 zuu zuu) (lex r);

readSignedRead'100 zuu vz = Nil;
...
readSignedRead'00 zuu (Tup2 x t) = Cons (Tup2 (negateMyInt x) t) Nil;
readSignedRead'00 zuu vx = Nil;

readSignedRead'0 zuu vu78 = readSignedRead'00 zuu vu78;

readSignedRead'101 zuu MyTrue (Tup2 (Cons vxw Nil) s) = concatMap (readSignedRead'0 zuu) (readSignedRead'' zuu s);
readSignedRead'101 zuu vxy vxz = readSignedRead'100 zuu vxz;

readSignedRead'102 zuu (Tup2 (Cons vxw vxx) s) = readSignedRead'101 zuu (esEsChar vxw (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))) (Tup2 (Cons vxw vxx) s);
readSignedRead'102 zuu vyu = readSignedRead'100 zuu vyu;

readSignedRead'10 zuu (Tup2 (Cons vxw vxx) s) = readSignedRead'102 zuu (Tup2 (Cons vxw vxx) s);
readSignedRead'10 zuu vz = readSignedRead'100 zuu vz;

readSignedRead'1 zuu vu79 = readSignedRead'10 zuu vu79;

readSignedRead' zuu r = psPs (readSignedRead'' zuu r) (concatMap (readSignedRead'1 zuu) (lex r));

readSigned readPos = readParen MyFalse (readSignedRead' readPos);

readsPrecMyInt :: MyInt  ->  (List Char)  ->  (List (Tup2 MyInt (List Char)))
readsPrecMyInt p = readSigned readDecMyInt;
