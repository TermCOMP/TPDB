{-# htermination (enumFromThenMyBool :: MyBool  ->  MyBool  ->  (List MyBool)) #-} 
...
numericEnumFromThenToP0 xu xv xw MyTrue = flip gtEsMyInt xu;

otherwise :: MyBool;
otherwise = MyTrue;

numericEnumFromThenToP1 xu xv xw MyTrue = flip ltEsMyInt xu;
numericEnumFromThenToP1 xu xv xw MyFalse = numericEnumFromThenToP0 xu xv xw otherwise;

numericEnumFromThenToP2 xu xv xw = numericEnumFromThenToP1 xu xv xw (gtEsMyInt xv xw);

numericEnumFromThenToP xu xv xw = numericEnumFromThenToP2 xu xv xw;
...
enumFromThenToMyBool :: MyBool  ->  MyBool  ->  MyBool  ->  (List MyBool)
enumFromThenToMyBool x y z = map toEnumMyBool (enumFromThenToMyInt (fromEnumMyBool x) (fromEnumMyBool y) (fromEnumMyBool z));

enumFromThenMyBool :: MyBool  ->  MyBool  ->  (List MyBool)
enumFromThenMyBool x y = enumFromThenToMyBool x y MyTrue;
