{-# htermination (read :: (List Char)  ->  Tup0) #-} 
...
span2Span0 zuz zvu p vwv vww MyTrue = Tup2 Nil (Cons vwv vww);

span2Vu43 zuz zvu = span zuz zvu;

span2Ys0 zuz zvu (Tup2 ys vwx) = ys;

span2Ys zuz zvu = span2Ys0 zuz zvu (span2Vu43 zuz zvu);

span2Zs0 zuz zvu (Tup2 vwy zs) = zs;

span2Zs zuz zvu = span2Zs0 zuz zvu (span2Vu43 zuz zvu);

span2Span1 zuz zvu p vwv vww MyTrue = Tup2 (Cons vwv (span2Ys zuz zvu)) (span2Zs zuz zvu);
span2Span1 zuz zvu p vwv vww MyFalse = span2Span0 zuz zvu p vwv vww otherwise;

span2 p (Cons vwv vww) = span2Span1 p vww p vwv vww (p vwv);

span3 p Nil = Tup2 Nil Nil;
span3 yzx yzy = span2 yzx yzy;
...
lex12LexExp5 yvz = lex12LexExp3 yvz;
...
lex12LexFracExp3 yux c cs MyTrue = concatMap lex12LexFracExp1 (lexDigits (Cons c cs));
lex12LexFracExp3 yux c cs MyFalse = lex12LexFracExp2 (Cons yux (Cons c cs));

lex12LexFracExp4 MyTrue (Cons yux (Cons c cs)) = lex12LexFracExp3 yux c cs (isDigit c);
lex12LexFracExp4 yvv yvw = lex12LexFracExp2 yvw;

lex12LexFracExp5 (Cons yux yvu) = lex12LexFracExp4 (esEsChar yux (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))) (Cons yux yvu);
lex12LexFracExp5 yvx = lex12LexFracExp2 yvx;

lex12LexFracExp (Cons yux yvu) = lex12LexFracExp5 (Cons yux yvu);
...
lexLitChar2LexEsc3 xx = Nil;

lexLitChar2LexEsc00 mne (Tup2 Nil s') = Cons (Tup2 mne s') Nil;
lexLitChar2LexEsc00 mne xz = Nil;
...
lexmatch2 vxw vxx = lexmatch0 vxw vxx;
...
lexLitChar2LexEsc10 s wz = Nil;

lexLitChar2LexEsc1 s vu70 = lexLitChar2LexEsc10 s vu70;

lexLitChar2LexEsc2 (Cons pr xy) = Cons pr Nil;
...
takeWhile3 yyz yzu = takeWhile2 yyz yzu;
...
lexLitChar2LexEsc4 xv xw MyTrue = lexLitChar2LexEsc2 (concatMap (lexLitChar2LexEsc1 (Cons xv xw)) lexLitChar2Table);
lexLitChar2LexEsc4 xv xw MyFalse = lexLitChar2LexEsc3 (Cons xv xw);

lexLitChar2LexEsc5 xv xw MyTrue = Cons (span isDigit (Cons xv xw)) Nil;
lexLitChar2LexEsc5 xv xw MyFalse = lexLitChar2LexEsc4 xv xw (isUpper xv);

lexLitChar2LexEsc6 (Cons xv xw) = lexLitChar2LexEsc5 xv xw (isDigit xv);
lexLitChar2LexEsc6 wvv = lexLitChar2LexEsc3 wvv;
...
lexLitChar2LexEsc7 MyTrue (Cons wvx s) = Cons (lexLitChar2Prefix (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (span isHexDigit s)) Nil;
lexLitChar2LexEsc7 wvy wvz = lexLitChar2LexEsc6 wvz;

lexLitChar2LexEsc8 (Cons wvx s) = lexLitChar2LexEsc7 (esEsChar wvx (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons wvx s);
lexLitChar2LexEsc8 wwu = lexLitChar2LexEsc6 wwu;
...
lexLitChar2LexEsc9 MyTrue (Cons www s) = Cons (lexLitChar2Prefix (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (span isOctDigit s)) Nil;
lexLitChar2LexEsc9 wwx wwy = lexLitChar2LexEsc8 wwy;

lexLitChar2LexEsc11 (Cons www s) = lexLitChar2LexEsc9 (esEsChar www (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons www s);
lexLitChar2LexEsc11 wwz = lexLitChar2LexEsc8 wwz;

lexLitChar2LexEsc12 wxv c s MyTrue = Cons (Tup2 (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons c Nil)) s) Nil;
lexLitChar2LexEsc12 wxv c s MyFalse = lexLitChar2LexEsc11 (Cons wxv (Cons c s));

lexLitChar2LexEsc13 MyTrue (Cons wxv (Cons c s)) = lexLitChar2LexEsc12 wxv c s (asAs (gtEsChar c (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (ltEsChar c (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
lexLitChar2LexEsc13 wxz wyu = lexLitChar2LexEsc11 wyu;

lexLitChar2LexEsc14 (Cons wxv wxy) = lexLitChar2LexEsc13 (esEsChar wxv (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons wxv wxy);
lexLitChar2LexEsc14 wyv = lexLitChar2LexEsc11 wyv;
...
lexLitChar2LexEsc16 wyx = lexLitChar2LexEsc14 wyx;

lexLitChar2LexEsc (Cons c s) = lexLitChar2LexEsc16 (Cons c s);
lexLitChar2LexEsc (Cons wxv wxy) = lexLitChar2LexEsc14 (Cons wxv wxy);
lexLitChar2LexEsc (Cons www s) = lexLitChar2LexEsc11 (Cons www s);
lexLitChar2LexEsc (Cons wvx s) = lexLitChar2LexEsc8 (Cons wvx s);
lexLitChar2LexEsc (Cons xv xw) = lexLitChar2LexEsc6 (Cons xv xw);
lexLitChar2LexEsc xx = lexLitChar2LexEsc3 xx;
...
lexLitChar3 Nil = Nil;
lexLitChar3 wzu = lexLitChar2 wzu;
...
dropWhile3 vyu vyv = dropWhile2 vyu vyv;
...
lex13LexStrItem001 MyTrue (Cons xzy t) = Cons (Tup2 Nil t) Nil;
lex13LexStrItem001 xzz yuu = lex13LexStrItem000 yuu;

lex13LexStrItem002 (Cons xzy t) = lex13LexStrItem001 (esEsChar xzy (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons xzy t);
lex13LexStrItem002 yuv = lex13LexStrItem000 yuv;

lex13LexStrItem00 (Cons xzy t) = lex13LexStrItem002 (Cons xzy t);
lex13LexStrItem00 vuw = lex13LexStrItem000 vuw;

lex13LexStrItem0 vu58 = lex13LexStrItem00 vu58;

lex13LexStrItem2 xwx c s MyTrue = concatMap lex13LexStrItem0 (Cons (dropWhile isSpace s) Nil);
lex13LexStrItem2 xwx c s MyFalse = lex13LexStrItem1 (Cons xwx (Cons c s));

lex13LexStrItem3 MyTrue (Cons xwx (Cons c s)) = lex13LexStrItem2 xwx c s (isSpace c);
lex13LexStrItem3 xxv xxw = lex13LexStrItem1 xxw;

lex13LexStrItem4 (Cons xwx xxu) = lex13LexStrItem3 (esEsChar xwx (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons xwx xxu);
lex13LexStrItem4 xxx = lex13LexStrItem1 xxx;

lex13LexStrItem5 MyTrue (Cons xxz (Cons xyv s)) = Cons (Tup2 (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))) Nil)) s) Nil;
lex13LexStrItem5 xyy xyz = lex13LexStrItem4 xyz;

lex13LexStrItem6 MyTrue (Cons xxz (Cons xyv s)) = lex13LexStrItem5 (esEsChar xyv (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))) (Cons xxz (Cons xyv s));
lex13LexStrItem6 xzu xzv = lex13LexStrItem4 xzv;

lex13LexStrItem7 (Cons xxz xyx) = lex13LexStrItem6 (esEsChar xxz (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (Cons xxz xyx);
lex13LexStrItem7 xzw = lex13LexStrItem4 xzw;

lex13LexStrItem (Cons xxz xyx) = lex13LexStrItem7 (Cons xxz xyx);
lex13LexStrItem (Cons xwx xxu) = lex13LexStrItem4 (Cons xwx xxu);
...
lex13LexString3 MyTrue (Cons xvy s) = Cons (Tup2 (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))) Nil) s) Nil;
lex13LexString3 xvz xwu = lex13LexString2 xwu;

lex13LexString4 (Cons xvy s) = lex13LexString3 (esEsChar xvy (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))) (Cons xvy s);
lex13LexString4 xwv = lex13LexString2 xwv;

lex13LexString (Cons xvy s) = lex13LexString4 (Cons xvy s);
lex13LexString s = lex13LexString2 s;

lex13 MyTrue (Cons yww s) = concatMap lex13Lex1 (lex13LexString s);
lex13 ywx ywy = lex12 ywy;

lex14 (Cons yww s) = lex13 (esEsChar yww (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))) (Cons yww s);
lex14 ywz = lex12 ywz;
...
lex002 MyTrue (Tup2 ch (Cons zuv t)) = lex000 ch t (fsEsListChar ch (Cons (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))) Nil));
lex002 zuw zux = lex001 zux;

lex003 (Tup2 ch (Cons zuv t)) = lex002 (esEsChar zuv (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))) (Tup2 ch (Cons zuv t));
lex003 zuy = lex001 zuy;

lex00 (Tup2 ch (Cons zuv t)) = lex003 (Tup2 ch (Cons zuv t));
lex00 vwz = lex001 vwz;

lex0 vu54 = lex00 vu54;

lex15 MyTrue (Cons yxv s) = concatMap lex0 (lexLitChar s);
lex15 yxw yxx = lex14 yxx;

lex16 (Cons yxv s) = lex15 (esEsChar yxv (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))) (Cons yxv s);
lex16 yxy = lex14 yxy;
...
lex (Cons yxv s) = lex16 (Cons yxv s);
lex (Cons yww s) = lex14 (Cons yww s);
...
readParenMandatory200 zvv ww = Nil;

readParenMandatory000 zvv x wx = Nil;

readParenMandatory001 zvv MyTrue x (Tup2 (Cons vzz Nil) u) = Cons (Tup2 x u) Nil;
readParenMandatory001 zvv wuv wuw wux = readParenMandatory000 zvv wuw wux;

readParenMandatory002 zvv x (Tup2 (Cons vzz wuu) u) = readParenMandatory001 zvv (esEsChar vzz (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))) x (Tup2 (Cons vzz wuu) u);
readParenMandatory002 zvv wuy wuz = readParenMandatory000 zvv wuy wuz;

readParenMandatory00 zvv x (Tup2 (Cons vzz wuu) u) = readParenMandatory002 zvv x (Tup2 (Cons vzz wuu) u);
readParenMandatory00 zvv x wx = readParenMandatory000 zvv x wx;

readParenMandatory0 zvv x vu48 = readParenMandatory00 zvv x vu48;

readParenMandatory10 zvv (Tup2 x t) = concatMap (readParenMandatory0 zvv x) (lex t);
readParenMandatory10 zvv wv = Nil;

readParenMandatory1 zvv vu49 = readParenMandatory10 zvv vu49;

readParenOptional zvv r = psPs (zvv r) (readParenMandatory zvv r);

readParenMandatory201 zvv MyTrue (Tup2 (Cons vyy Nil) s) = concatMap (readParenMandatory1 zvv) (readParenOptional zvv s);
readParenMandatory201 zvv vzu vzv = readParenMandatory200 zvv vzv;

readParenMandatory202 zvv (Tup2 (Cons vyy vyz) s) = readParenMandatory201 zvv (esEsChar vyy (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))) (Tup2 (Cons vyy vyz) s);
readParenMandatory202 zvv vzw = readParenMandatory200 zvv vzw;

readParenMandatory20 zvv (Tup2 (Cons vyy vyz) s) = readParenMandatory202 zvv (Tup2 (Cons vyy vyz) s);
readParenMandatory20 zvv ww = readParenMandatory200 zvv ww;

readParenMandatory2 zvv vu50 = readParenMandatory20 zvv vu50;

readParenMandatory zvv r = concatMap (readParenMandatory2 zvv) (lex r);

readParenReadParen0 zvv MyTrue = readParenMandatory zvv;
readParenReadParen0 zvv MyFalse = readParenOptional zvv;
...
readsPrec001 MyTrue (Tup2 (Cons xuy Nil) t) = Cons (Tup2 Tup0 t) Nil;
readsPrec001 xvu xvv = readsPrec000 xvv;

readsPrec002 (Tup2 (Cons xuy xuz) t) = readsPrec001 (esEsChar xuy (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))) (Tup2 (Cons xuy xuz) t);
readsPrec002 xvw = readsPrec000 xvw;

readsPrec00 (Tup2 (Cons xuy xuz) t) = readsPrec002 (Tup2 (Cons xuy xuz) t);
readsPrec00 zy = readsPrec000 zy;

readsPrec0 vu22 = readsPrec00 vu22;

readsPrec101 MyTrue (Tup2 (Cons wzx Nil) s) = concatMap readsPrec0 (lex s);
readsPrec101 wzz xuu = readsPrec100 xuu;

readsPrec102 (Tup2 (Cons wzx wzy) s) = readsPrec101 (esEsChar wzx (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))) (Tup2 (Cons wzx wzy) s);
readsPrec102 xuv = readsPrec100 xuv;

readsPrec10 (Tup2 (Cons wzx wzy) s) = readsPrec102 (Tup2 (Cons wzx wzy) s);
readsPrec10 yu = readsPrec100 yu;
...
read s = read2 (concatMap read1 (readsTup0 s));
