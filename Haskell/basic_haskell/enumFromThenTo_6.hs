{-# htermination (enumFromThenToOrdering :: Ordering  ->  Ordering  ->  Ordering  ->  (List Ordering)) #-} 
...
numericEnumFromThenToP0 xy xz yu MyTrue = flip gtEsMyInt yu;

otherwise :: MyBool;
otherwise = MyTrue;

numericEnumFromThenToP1 xy xz yu MyTrue = flip ltEsMyInt yu;
numericEnumFromThenToP1 xy xz yu MyFalse = numericEnumFromThenToP0 xy xz yu otherwise;

numericEnumFromThenToP2 xy xz yu = numericEnumFromThenToP1 xy xz yu (gtEsMyInt xy xz);
