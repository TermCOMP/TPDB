{-# htermination (readsPrecTup0 :: MyInt  ->  (List Char)  ->  (List (Tup2 Tup0 (List Char)))) #-} 
...
span2Span0 zux zuy p vvy vvz MyTrue = Tup2 Nil (Cons vvy vvz);

span2Vu43 zux zuy = span zux zuy;

span2Ys0 zux zuy (Tup2 ys vwu) = ys;

span2Ys zux zuy = span2Ys0 zux zuy (span2Vu43 zux zuy);

span2Zs0 zux zuy (Tup2 vwv zs) = zs;

span2Zs zux zuy = span2Zs0 zux zuy (span2Vu43 zux zuy);

span2Span1 zux zuy p vvy vvz MyTrue = Tup2 (Cons vvy (span2Ys zux zuy)) (span2Zs zux zuy);
span2Span1 zux zuy p vvy vvz MyFalse = span2Span0 zux zuy p vvy vvz otherwise;
...
lex12LexExp5 yuu = lex12LexExp3 yuu;
...
lex12LexFracExp3 yuw c cs MyTrue = concatMap lex12LexFracExp1 (lexDigits (Cons c cs));
lex12LexFracExp3 yuw c cs MyFalse = lex12LexFracExp2 (Cons yuw (Cons c cs));

lex12LexFracExp4 MyTrue (Cons yuw (Cons c cs)) = lex12LexFracExp3 yuw c cs (isDigit c);
lex12LexFracExp4 yvu yvv = lex12LexFracExp2 yvv;

lex12LexFracExp5 (Cons yuw yuz) = lex12LexFracExp4 (esEsChar yuw (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))))))))) (Cons yuw yuz);
lex12LexFracExp5 yvw = lex12LexFracExp2 yvw;

lex12LexFracExp (Cons yuw yuz) = lex12LexFracExp5 (Cons yuw yuz);
...
readParenMandatory200 zuw ww = Nil;

readParenMandatory000 zuw x wx = Nil;

readParenMandatory001 zuw MyTrue x (Tup2 (Cons vzw Nil) u) = Cons (Tup2 x u) Nil;
readParenMandatory001 zuw vzy vzz wuu = readParenMandatory000 zuw vzz wuu;

readParenMandatory002 zuw x (Tup2 (Cons vzw vzx) u) = readParenMandatory001 zuw (esEsChar vzw (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))))))))))))))))))))))))))))))) x (Tup2 (Cons vzw vzx) u);
readParenMandatory002 zuw wuv wuw = readParenMandatory000 zuw wuv wuw;

readParenMandatory00 zuw x (Tup2 (Cons vzw vzx) u) = readParenMandatory002 zuw x (Tup2 (Cons vzw vzx) u);
readParenMandatory00 zuw x wx = readParenMandatory000 zuw x wx;

readParenMandatory0 zuw x vu48 = readParenMandatory00 zuw x vu48;

readParenMandatory10 zuw (Tup2 x t) = concatMap (readParenMandatory0 zuw x) (lex t);
readParenMandatory10 zuw wv = Nil;

readParenMandatory1 zuw vu49 = readParenMandatory10 zuw vu49;

readParenOptional zuw r = psPs (zuw r) (readParenMandatory zuw r);

readParenMandatory201 zuw MyTrue (Tup2 (Cons vyv Nil) s) = concatMap (readParenMandatory1 zuw) (readParenOptional zuw s);
readParenMandatory201 zuw vyx vyy = readParenMandatory200 zuw vyy;

readParenMandatory202 zuw (Tup2 (Cons vyv vyw) s) = readParenMandatory201 zuw (esEsChar vyv (Char (Pos (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))))))))))))))))))))))))))))))) (Tup2 (Cons vyv vyw) s);
readParenMandatory202 zuw vyz = readParenMandatory200 zuw vyz;

readParenMandatory20 zuw (Tup2 (Cons vyv vyw) s) = readParenMandatory202 zuw (Tup2 (Cons vyv vyw) s);
readParenMandatory20 zuw ww = readParenMandatory200 zuw ww;

readParenMandatory2 zuw vu50 = readParenMandatory20 zuw vu50;

readParenMandatory zuw r = concatMap (readParenMandatory2 zuw) (lex r);

readParenReadParen0 zuw MyTrue = readParenMandatory zuw;
readParenReadParen0 zuw MyFalse = readParenOptional zuw;
