{-# htermination (properFractionFloat :: Float  ->  Tup2 MyInt Float) #-} 
...
floatProperFractionFloat (Float vv vw) = Tup2 (quotMyInt vv vw) (msFloat (Float vv vw) (fromIntFloat (quotMyInt vv vw)));
