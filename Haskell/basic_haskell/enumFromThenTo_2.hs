{-# htermination (enumFromThenToMyBool :: MyBool  ->  MyBool  ->  MyBool  ->  (List MyBool)) #-} 
...
numericEnumFromThenToP0 xu xv xw MyTrue = flip gtEsMyInt xw;

otherwise :: MyBool;
otherwise = MyTrue;

numericEnumFromThenToP1 xu xv xw MyTrue = flip ltEsMyInt xw;
numericEnumFromThenToP1 xu xv xw MyFalse = numericEnumFromThenToP0 xu xv xw otherwise;

numericEnumFromThenToP2 xu xv xw = numericEnumFromThenToP1 xu xv xw (gtEsMyInt xu xv);
