...
(define-fun next_main (
  ...
  (or
    ...
    (cfg_trans2 pc^0 l2 pc^post l4 (and (and (and (and (and (and (and (<= 0 (+ 0 i_5^0)) (= i_5^post (+ (+ 0 (* -1 d_6^0)) i_5^0))) (= Result_4^0 Result_4^post)) (= __cil_tmp2_10^0 __cil_tmp2_10^post)) (= __cil_tmp4_8^0 __cil_tmp4_8^post)) (= __retres1_9^0 __retres1_9^post)) (= __retres3_7^0 __retres3_7^post)) (= d_6^0 d_6^post)))
