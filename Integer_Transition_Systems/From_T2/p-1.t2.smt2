...
(define-fun next_main (
  ...
  (or
    ...
    (cfg_trans2 pc^0 l1 pc^post l2 (exists ( (lt_8^1 Int) (lt_9^1 Int) ) (and (and (and (and (and (and (and (and (and (and (= lt_8^1 (+ 0 cnt_15^0)) (= lt_9^1 (+ 0 cnt_20^0))) (<= (+ (+ 0 (* -1 lt_8^1)) lt_9^1) 0)) (= lt_8^post lt_8^post)) (= lt_9^post lt_9^post)) (= Result_4^post Result_4^post)) (= cnt_15^0 cnt_15^post)) (= cnt_20^0 cnt_20^post)) (= lt_7^0 lt_7^post)) (= x_5^0 x_5^post)) (= y_6^0 y_6^post))))
    (cfg_trans2 pc^0 l1 pc^post l3 (exists ( (lt_7^1 Int) (lt_8^1 Int) (lt_9^1 Int) ) (and (and (and (and (and (and (and (and (and (and (and (= lt_8^1 (+ 0 cnt_15^0)) (= lt_9^1 (+ 0 cnt_20^0))) (<= 0 (+ (+ -1 (* -1 lt_8^1)) lt_9^1))) (= lt_8^post lt_8^post)) (= lt_9^post lt_9^post)) (= lt_7^1 (+ 0 cnt_15^0))) (= lt_7^post lt_7^post)) (= Result_4^0 Result_4^post)) (= cnt_15^0 cnt_15^post)) (= cnt_20^0 cnt_20^post)) (= x_5^0 x_5^post)) (= y_6^0 y_6^post))))
    ...
    (cfg_trans2 pc^0 l4 pc^post l0 (and (and (and (and (and (and (and (= Result_4^0 Result_4^post) (= cnt_15^0 cnt_15^post)) (= cnt_20^0 cnt_20^post)) (= lt_7^0 lt_7^post)) (= lt_8^0 lt_8^post)) (= lt_9^0 lt_9^post)) (= x_5^0 x_5^post)) (= y_6^0 y_6^post)))
  )
)
