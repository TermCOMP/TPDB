...
(define-fun next_main (
  ...
  (or
    ...
    (cfg_trans2 pc^0 l10 pc^post l11 (and (and (and (and (and (and (and (<= (+ 0 edgecount^0) (+ 0 j^0)) (= i^post (+ 1 i^0))) (= edgecount^0 edgecount^post)) (= j^0 j^post)) (= nodecount^0 nodecount^post)) (= source^0 source^post)) (= x^0 x^post)) (= y^0 y^post)))
    (cfg_trans2 pc^0 l10 pc^post l8 (and (and (and (and (and (and (and (<= (+ 1 j^0) (+ 0 edgecount^0)) (= x^post x^post)) (= y^post y^post)) (= edgecount^0 edgecount^post)) (= i^0 i^post)) (= j^0 j^post)) (= nodecount^0 nodecount^post)) (= source^0 source^post)))
    ...
    (cfg_trans2 pc^0 l12 pc^post l4 (and (and (and (and (and (and (and (<= (+ 0 nodecount^0) (+ 0 i^0)) (= i^post 0)) (= edgecount^0 edgecount^post)) (= j^0 j^post)) (= nodecount^0 nodecount^post)) (= source^0 source^post)) (= x^0 x^post)) (= y^0 y^post)))
    (cfg_trans2 pc^0 l12 pc^post l9 (and (and (and (and (and (and (and (<= (+ 1 i^0) (+ 0 nodecount^0)) (= j^post 0)) (= edgecount^0 edgecount^post)) (= i^0 i^post)) (= nodecount^0 nodecount^post)) (= source^0 source^post)) (= x^0 x^post)) (= y^0 y^post)))
    ...
    (cfg_trans2 pc^0 l14 pc^post l6 (and (and (and (and (and (and (= i^post (+ 1 i^0)) (= edgecount^0 edgecount^post)) (= j^0 j^post)) (= nodecount^0 nodecount^post)) (= source^0 source^post)) (= x^0 x^post)) (= y^0 y^post)))
    ...
    (cfg_trans2 pc^0 l7 pc^post l11 (and (and (and (and (and (and (and (<= (+ 0 nodecount^0) (+ 0 i^0)) (= i^post 0)) (= edgecount^0 edgecount^post)) (= j^0 j^post)) (= nodecount^0 nodecount^post)) (= source^0 source^post)) (= x^0 x^post)) (= y^0 y^post)))
    (cfg_trans2 pc^0 l7 pc^post l15 (and (and (and (and (and (and (and (<= (+ 1 i^0) (+ 0 nodecount^0)) (= edgecount^0 edgecount^post)) (= i^0 i^post)) (= j^0 j^post)) (= nodecount^0 nodecount^post)) (= source^0 source^post)) (= x^0 x^post)) (= y^0 y^post)))
    ...
    (cfg_trans2 pc^0 l16 pc^post l6 (and (and (and (and (and (and (= nodecount^post 5) (= edgecount^post 10)) (= source^post 0)) (= i^post 0)) (= j^0 j^post)) (= x^0 x^post)) (= y^0 y^post)))
