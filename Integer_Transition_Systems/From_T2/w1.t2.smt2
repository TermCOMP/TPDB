...
(define-fun next_main (
  ...
  (or
    (cfg_trans2 pc^0 l0 pc^post l1 (exists ( (x^1 Int) ) (and (and (and (and (and (= x^1 x^1) (<= 1 (+ 0 x^1))) (<= 2 (+ 0 x^1))) (= x^post x^post)) (<= -1 (+ 0 x^post))) (<= (+ 1 x^post) 2))))
    (cfg_trans2 pc^0 l1 pc^post l0 (= x^0 x^post))
    (cfg_trans2 pc^0 l2 pc^post l0 (and (= x^post x^post) (<= 2 (+ 0 x^post))))
