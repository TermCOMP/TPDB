...
(define-fun next_main (
  ...
  (or
    ...
    (cfg_trans2 pc^0 l3 pc^post l4 (exists ( (res10^1 Int) (res10^2 Int) (res10^3 Int) (res10^4 Int) ) (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (<= (+ 0 (* 2 __const_8^0)) (+ 0 nI6^0)) (= ret_nBC18^post (+ 0 res5^0))) (= tmp^post (+ 0 ret_nBC18^post))) (= nX9^post (+ 0 nX^0))) (= res10^1 (+ 0 nX9^post))) (= res10^2 res10^2)) (= res10^3 res10^3)) (= res10^4 res10^4)) (= res10^post res10^post)) (= ret_nBC211^post (+ 0 res10^post))) (= tmp___0^post (+ 0 ret_nBC211^post))) (= __const_8^0 __const_8^post)) (= nI6^0 nI6^post)) (= nX^0 nX^post)) (= nX4^0 nX4^post)) (= res5^0 res5^post)) (= tmp7^0 tmp7^post))))
    (cfg_trans2 pc^0 l3 pc^post l2 (and (and (and (and (and (and (and (and (and (and (and (and (<= (+ 1 nI6^0) (+ 0 (* 2 __const_8^0))) (= __const_8^0 __const_8^post)) (= nI6^0 nI6^post)) (= nX^0 nX^post)) (= nX4^0 nX4^post)) (= nX9^0 nX9^post)) (= res10^0 res10^post)) (= res5^0 res5^post)) (= ret_nBC18^0 ret_nBC18^post)) (= ret_nBC211^0 ret_nBC211^post)) (= tmp^0 tmp^post)) (= tmp7^0 tmp7^post)) (= tmp___0^0 tmp___0^post)))
