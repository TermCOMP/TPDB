...
(define-fun next_main (
  ...
  (or
    (cfg_trans2 pc^0 l0 pc^post l1 (and (and (<= (+ 0 x^0) (+ 0 x^0)) (<= (+ 0 x^0) (+ 0 x^0))) (= x^0 x^post)))
    (cfg_trans2 pc^0 l1 pc^post l0 (= x^0 x^post))
    (cfg_trans2 pc^0 l2 pc^post l3 (= x^0 x^post))
    (cfg_trans2 pc^0 l3 pc^post l2 (= x^0 x^post))
    (cfg_trans2 pc^0 l4 pc^post l0 (= x^0 x^post))
