...
(define-fun next_main (
  ...
  (or
    ...
    (cfg_trans2 pc^0 l2 pc^post l3 (and (and (and (and (and (and (and (and (= oldX0^post (+ 0 x0^0)) (= oldX1^post (+ 0 x1^0))) (= oldX2^post (+ 0 x2^0))) (= x0^post (+ 0 oldX0^post))) (= x1^post (+ 0 oldX1^post))) (= x2^post (+ (+ 0 (* -1 oldX1^post)) oldX2^post))) (= oldX3^0 oldX3^post)) (= oldX4^0 oldX4^post)) (= oldX5^0 oldX5^post)))
    ...
    (cfg_trans2 pc^0 l3 pc^post l0 (and (and (and (and (and (and (and (and (and (= oldX0^post (+ 0 x0^0)) (= oldX1^post (+ 0 x1^0))) (= oldX2^post (+ 0 x2^0))) (<= (+ 1 oldX2^post) (+ 0 oldX1^post))) (= x0^post (+ 0 oldX0^post))) (= x1^post (+ 0 oldX1^post))) (= x2^post (+ 0 oldX2^post))) (= oldX3^0 oldX3^post)) (= oldX4^0 oldX4^post)) (= oldX5^0 oldX5^post)))
    (cfg_trans2 pc^0 l3 pc^post l2 (and (and (and (and (and (and (and (and (and (and (= oldX0^post (+ 0 x0^0)) (= oldX1^post (+ 0 x1^0))) (= oldX2^post (+ 0 x2^0))) (<= (+ 0 oldX1^post) (+ 0 oldX2^post))) (<= 1 (+ 0 oldX1^post))) (= x0^post (+ 0 oldX0^post))) (= x1^post (+ 0 oldX1^post))) (= x2^post (+ 0 oldX2^post))) (= oldX3^0 oldX3^post)) (= oldX4^0 oldX4^post)) (= oldX5^0 oldX5^post)))
    (cfg_trans2 pc^0 l4 pc^post l3 (and (and (and (and (and (and (and (and (= oldX0^post (+ 0 x0^0)) (= oldX1^post (+ 0 x1^0))) (= oldX2^post (+ 0 x2^0))) (= x0^post (+ 0 oldX0^post))) (= x1^post (+ 0 oldX1^post))) (= x2^post (+ 0 oldX0^post))) (= oldX3^0 oldX3^post)) (= oldX4^0 oldX4^post)) (= oldX5^0 oldX5^post)))
