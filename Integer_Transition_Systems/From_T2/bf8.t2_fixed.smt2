...
(define-fun next_main (
  ...
  (or
    ...
    (cfg_trans2 pc^0 l9 pc^post l4 (and (and (and (and (and (and (and (<= (+ 0 nodecount^0) (+ 0 i^0)) (= i^post 0)) (= edgecount^0 edgecount^post)) (= j^0 j^post)) (= nodecount^0 nodecount^post)) (= source^0 source^post)) (= x^0 x^post)) (= y^0 y^post)))
    ...
    (cfg_trans2 pc^0 l6 pc^post l8 (and (and (and (and (and (and (and (<= (+ 0 nodecount^0) (+ 0 i^0)) (= i^post 0)) (= edgecount^0 edgecount^post)) (= j^0 j^post)) (= nodecount^0 nodecount^post)) (= source^0 source^post)) (= x^0 x^post)) (= y^0 y^post)))
    ...
    (cfg_trans2 pc^0 l16 pc^post l5 (and (and (and (and (and (and (= nodecount^post 5) (= edgecount^post 8)) (= source^post 0)) (= i^post 0)) (= j^0 j^post)) (= x^0 x^post)) (= y^0 y^post)))
