...
(define-fun next_main (
  ...
  (or
    ...
    (cfg_trans2 pc^0 l6 pc^post l5 (and (and (and (<= 3 (+ 0 WItemsNum^0)) (= WItemsNum^post (+ -1 WItemsNum^0))) (= ___rho_1_^0 ___rho_1_^post)) (= ___rho_2_^0 ___rho_2_^post)))
    (cfg_trans2 pc^0 l6 pc^post l0 (and (and (and (<= (+ 0 WItemsNum^0) 2) (= WItemsNum^post 1)) (= ___rho_1_^0 ___rho_1_^post)) (= ___rho_2_^0 ___rho_2_^post)))
    ...
    (cfg_trans2 pc^0 l11 pc^post l5 (and (and (and (<= 1 (+ 0 ___rho_2_^0)) (= WItemsNum^0 WItemsNum^post)) (= ___rho_1_^0 ___rho_1_^post)) (= ___rho_2_^0 ___rho_2_^post)))
