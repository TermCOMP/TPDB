...
(define-fun next_main (
  ...
  (or
    ...
    (cfg_trans2 pc^0 l14 pc^post l10 (and (and (and (and (and (and (= i^post (+ 1 i^0)) (= edgecount^0 edgecount^post)) (= j^0 j^post)) (= nodecount^0 nodecount^post)) (= source^0 source^post)) (= x^0 x^post)) (= y^0 y^post)))
    ...
    (cfg_trans2 pc^0 l11 pc^post l9 (and (and (and (and (and (and (and (<= (+ 0 nodecount^0) (+ 0 i^0)) (= i^post 0)) (= edgecount^0 edgecount^post)) (= j^0 j^post)) (= nodecount^0 nodecount^post)) (= source^0 source^post)) (= x^0 x^post)) (= y^0 y^post)))
    (cfg_trans2 pc^0 l11 pc^post l15 (and (and (and (and (and (and (and (<= (+ 1 i^0) (+ 0 nodecount^0)) (= edgecount^0 edgecount^post)) (= i^0 i^post)) (= j^0 j^post)) (= nodecount^0 nodecount^post)) (= source^0 source^post)) (= x^0 x^post)) (= y^0 y^post)))
    ...
    (cfg_trans2 pc^0 l16 pc^post l10 (and (and (and (and (and (and (= nodecount^post 5) (= edgecount^post 13)) (= source^post 0)) (= i^post 0)) (= j^0 j^post)) (= x^0 x^post)) (= y^0 y^post)))
