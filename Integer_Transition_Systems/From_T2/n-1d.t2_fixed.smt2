...
(define-fun next_main (
  ...
  (or
    ...
    (cfg_trans2 pc^0 l0 pc^post l2 (and (and (and (and (and (and (<= 0 (+ (+ -1 (* -1 x_5^0)) y_6^0)) (= tmp_7^post tmp_7^post)) (<= (+ 0 tmp_7^post) 0)) (<= 0 (+ 0 tmp_7^post))) (= Result_4^0 Result_4^post)) (= x_5^0 x_5^post)) (= y_6^0 y_6^post)))
