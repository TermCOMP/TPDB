...
(define-fun next_main (
  ...
  (or
    ...
    (cfg_trans2 pc^0 l2 pc^post l0 (= p^post 1))
    (cfg_trans2 pc^0 l2 pc^post l0 (= p^post 0))
    (cfg_trans2 pc^0 l3 pc^post l2 (exists ( (p^1 Int) ) (and (= p^1 0) (= p^post 1))))
    (cfg_trans2 pc^0 l4 pc^post l3 (= p^0 p^post))
  )
)
