...
(define-fun next_main (
  ...
  (or
    ...
    (cfg_trans2 pc^0 l7 pc^post l0 (and (and (and (and (and (= c^post c^post) (<= 1 (+ 0 c^post))) (= servers^post 8)) (= resp^post 0)) (= curr_serv^post (+ 0 servers^post))) (= ___rho_1_^0 ___rho_1_^post)))
