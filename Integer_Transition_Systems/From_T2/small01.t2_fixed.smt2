...
(define-fun next_main (
  ...
  (or
    ...
    (cfg_trans2 pc^0 l2 pc^post l1 (and (<= 1 (+ 0 x^0)) (= x^0 x^post)))
    (cfg_trans2 pc^0 l2 pc^post l1 (and (<= (+ 1 x^0) 0) (= x^0 x^post)))
    (cfg_trans2 pc^0 l1 pc^post l0 (= x^0 x^post))
    (cfg_trans2 pc^0 l3 pc^post l0 (and (<= 1 (+ 0 x^0)) (= x^0 x^post)))
