...
(define-fun next_main (
  ...
  (or
    (cfg_trans2 pc^0 l0 pc^post l1 (and (and (<= 11 (+ 0 x^0)) (= x^0 x^post)) (= y^0 y^post)))
    (cfg_trans2 pc^0 l0 pc^post l2 (and (and (<= (+ 0 x^0) 10) (= y^post (+ 10 (* -1 x^0)))) (= x^post (+ 1 x^0))))
    (cfg_trans2 pc^0 l2 pc^post l0 (and (= x^0 x^post) (= y^0 y^post)))
    (cfg_trans2 pc^0 l3 pc^post l2 (and (= x^post 1) (= y^0 y^post)))
