...
(define-fun next_main (
  ...
  (or
    (cfg_trans2 pc^0 l0 pc^post l1 (and (and (<= (+ 1 x^0) 0) (= x^0 x^post)) (= y^0 y^post)))
    (cfg_trans2 pc^0 l0 pc^post l2 (and (and (<= 0 (+ 0 x^0)) (= x^post (+ (+ 0 x^0) (* -1 y^0)))) (= y^0 y^post)))
    (cfg_trans2 pc^0 l2 pc^post l0 (and (= x^0 x^post) (= y^0 y^post)))
    (cfg_trans2 pc^0 l3 pc^post l0 (and (and (and (<= (+ (+ 1 x^0) y^0) 0) (<= 1 (+ 0 x^0))) (= x^0 x^post)) (= y^0 y^post)))
