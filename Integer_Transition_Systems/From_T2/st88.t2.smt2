...
(define-fun next_main (
  ...
  (or
    (cfg_trans2 pc^0 l0 pc^post l1 (and (and (and (<= (+ 1 __const_5^0) (+ 0 WItemsNum^0)) (= tmp1^post tmp1^post)) (= WItemsNum^0 WItemsNum^post)) (= __const_5^0 __const_5^post)))
    (cfg_trans2 pc^0 l0 pc^post l2 (and (and (and (<= (+ 0 WItemsNum^0) (+ 0 __const_5^0)) (= WItemsNum^0 WItemsNum^post)) (= __const_5^0 __const_5^post)) (= tmp1^0 tmp1^post)))
    ...
    (cfg_trans2 pc^0 l1 pc^post l5 (and (and (and (and (<= (+ 0 tmp1^0) 0) (<= 0 (+ 0 tmp1^0))) (= WItemsNum^0 WItemsNum^post)) (= __const_5^0 __const_5^post)) (= tmp1^0 tmp1^post)))
    (cfg_trans2 pc^0 l1 pc^post l2 (and (and (and (<= 1 (+ 0 tmp1^0)) (= WItemsNum^0 WItemsNum^post)) (= __const_5^0 __const_5^post)) (= tmp1^0 tmp1^post)))
    (cfg_trans2 pc^0 l1 pc^post l2 (and (and (and (<= (+ 1 tmp1^0) 0) (= WItemsNum^0 WItemsNum^post)) (= __const_5^0 __const_5^post)) (= tmp1^0 tmp1^post)))
    (cfg_trans2 pc^0 l2 pc^post l4 (and (and (and (<= (+ 1 __const_5^0) (+ 0 WItemsNum^0)) (= WItemsNum^post (+ 1 WItemsNum^0))) (= __const_5^0 __const_5^post)) (= tmp1^0 tmp1^post)))
    (cfg_trans2 pc^0 l2 pc^post l4 (and (and (and (<= (+ 0 WItemsNum^0) (+ 0 __const_5^0)) (= WItemsNum^post (+ 1 WItemsNum^0))) (= __const_5^0 __const_5^post)) (= tmp1^0 tmp1^post)))
    (cfg_trans2 pc^0 l12 pc^post l3 (exists ( (WItemsNum^1 Int) ) (and (and (and (= WItemsNum^1 WItemsNum^1) (= WItemsNum^post WItemsNum^post)) (= __const_5^0 __const_5^post)) (= tmp1^0 tmp1^post))))
    (cfg_trans2 pc^0 l13 pc^post l12 (and (and (= WItemsNum^0 WItemsNum^post) (= __const_5^0 __const_5^post)) (= tmp1^0 tmp1^post)))
  )
)
